          ...
          <div className="flex justify-between items-center mb-2">
            ...
            <div className={`flex items-center gap-3 bg-[#1a1f3a]/60 backdrop-blur-md border ${themeBorder} rounded-xl px-4 py-2`}>
              <div className="flex flex-col items-end gap-1">
                <span className="text-xs text-gray-400">wallet app</span>
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div className="asset-item">
                    ...
                    <div className="asset-amount" style={{ color: themeColor }}>{displaySolBalance.toFixed(2)}</div>
                  </div>
                  <div className="asset-item">
                    ...
                    <div className="asset-amount" style={{ color: themeColor }}>{displayNocBalance.toFixed(0)}</div>
                  </div>
                </div>
              </div>
