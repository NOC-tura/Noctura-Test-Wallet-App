export function serializeTransferMultiWitness({ inputNotes, merkleProofs, outputNote1, outputNote2, }) {
    ...
    if (paddedInputTotal !== outputTotal) {
        ...
        throw new Error(`Amount conservation failed. With ${inputNotes.length} notes padded to 4, ` +
...
export function serializeTransferMultiPublicInputs(witness) {
    return [
