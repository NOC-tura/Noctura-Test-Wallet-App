import {
  ...
  serializeTransferWitness,
  serializeWithdrawWitness,
  serializeTransferPublicInputs,
  serializeWithdrawPublicInputs,
} from '../witness/index.js';

const tokenMint = 1_234_567n;
...
const out1 = createNote({ secret: 1n, amount: 50_000_000n, tokenMint, blinding: 2n, rho: 3n });
const out2 = createNote({ secret: 4n, amount: 50_000_000n, tokenMint, blinding: 5n, rho: 6n });
