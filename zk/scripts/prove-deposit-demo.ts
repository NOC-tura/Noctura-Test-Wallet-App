...
const globals = globalThis as typeof globalThis & { curve_bn128?: CurveHandle };
...
function toBytesBE(value: bigint, length = 32): Uint8Array {
...
function toBytesLE(value: bigint, length = 32): Uint8Array {
  const out = new Uint8Array(length);
  let tmp = value;
...
function serializePublicSignals(signals: any[]): string[] {
